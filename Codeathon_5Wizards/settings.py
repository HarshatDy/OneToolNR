"""
Django settings for Codeathon_5Wizards project.
...
ALLOWED_HOSTS = [ 'radisys-one-app-5gnr.herokuapp.com',"127.0.0.1"]
...
ROOT_URLCONF = 'Codeathon_5Wizards.urls'
...
WSGI_APPLICATION = 'Codeathon_5Wizards.wsgi.application'
